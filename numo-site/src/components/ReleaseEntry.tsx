    ...
    >
      ...
      <header className="md:pt-1">
        ...
        <time
          ...
          className="mt-2 block text-xs uppercase tracking-[0.2em] font-semibold text-navy/65"
        >
      ...
      <div>
        ...
        <a
          ...
          className="mt-10 inline-flex items-center gap-1.5 text-sm font-medium text-navy/65 hover:text-navy transition-colors duration-200 underline underline-offset-4 decoration-navy/40 hover:decoration-navy/60"
        >
